<script lang="ts">
	...
	const getPlayerStats = async () => {
		const playerId = page.params.discriminator;
	...
	let statsPromise = $state(getPlayerStats());
				...
				<div class="dialog-controls">
					<div class="upper">
						<ol>
							...
							<li>
								Share your video on social media using <span class="hashtag">#SmashRecap</span>
							</li>
						</ol>
